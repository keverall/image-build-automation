...
class AuditLogger:
    ...
    def __init__(self, category: str, log_dir: Path = Path("generated/logs"), master_log: str = "audit.log"):
        """
...
def save_audit_record(
    audit_data: dict, log_dir: Path = Path("generated/logs"), subdir: Optional[str] = None, prefix: str = ""
) -> Path:
    """
