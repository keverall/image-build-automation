...
if ($ShowHelp) {
    ...
    Write-Output '        "Prod": {'
    Write-Output '          "scom": {'
    Write-Output '            "management_server": "VR-OPM19P1-7382.ad.aib.pri",'
    Write-Output '            "group_id": "PROD-SERVERS-GROUP",'
    Write-Output '            "environment": "production"'
    Write-Output '          },'
    Write-Output '          "oneview": {'
    Write-Output '            "appliance": "oneview.ad.aib.pri",'
    Write-Output '            "scope_name": "Production_Cluster_01"'
    Write-Output '          }'
    Write-Output '        },'
    Write-Output '        "Test": {'
    Write-Output '          "scom": {'
    Write-Output '            "management_server": "VR-OPM19T1-7382.ad.aib.pri",'
