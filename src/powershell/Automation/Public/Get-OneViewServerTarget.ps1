...
function Get-OneViewServerTarget {
    ...
    .PARAMETER OneViewHost
        OneView appliance hostname or IP (e.g. oneview.ad.aib.pri).
    ...
    .EXAMPLE
        Get-OneViewServerTarget -OneViewHost 'oneview.ad.aib.pri' -ServerIdentifier 'PROD-SERVER-01'

    .EXAMPLE
        Get-OneViewServerTarget -OneViewHost 'oneview.ad.aib.pri' -ServerIdentifier 'MXQ1234567' -IdentifierType Serial
    #>
    [CmdletBinding()]
