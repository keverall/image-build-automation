...
# =============================================================================
# (No proxy manipulation functions.)
# The connectivity test reaches the OneView appliance directly. The
# Test-ServerConnectivity command runs Connect-OVMgmt inside a fresh
# -NoProfile child process (via Invoke-PowerShellScript) and disconnects
# immediately afterwards, which avoids the corporate web proxy entirely.
# =============================================================================
