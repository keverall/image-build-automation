...
# Shared canonical TOC/anchor + "top" anchor logic (single source of truth also
# used by bitbucket-md-anchor-toc.ps1). Dot-sourced first so the local Write-Status
# defined further down overrides it for this script's own logging.
...
# Canonicalize at generation time: add Bitbucket/GitStash anchors, a Table of
# Contents, and the document "top" anchor so the generated doc matches the
# canonical form produced by `make fix-docs` for the rest of the repo. This keeps
