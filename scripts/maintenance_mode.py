...
Usage examples:
  python maintenance_mode.py --cluster-id PROD-CLUSTER-01 --start now --end 2025-05-15T08:00:00
  python maintenance_mode.py --cluster-id PROD-CLUSTER-01 --disable
  python maintenance_mode.py --cluster-id PROD-CLUSTER-01 --validate-only
"""
