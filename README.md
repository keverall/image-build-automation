...
Then use:
```powershell
mm enable CLU-CLUSTER-01 scom Prod    # Enable maintenance mode
mm disable CLU-CLUSTER-01 scom Prod   # Disable maintenance mode
mm validate CLU-CLUSTER-01 scom Prod  # Check status
```
...
| Enable maintenance mode | `mm enable CLUSTER scom Prod -Start now -End +2hours` | Maintenance Mode |
