...
Then use:
```powershell
Set-MaintenanceMode -Action enable -TargetId CLU-CLUSTER-01 -Mode scom -Environment Prod    # Enable maintenance mode
Set-MaintenanceMode -Action disable -TargetId CLU-CLUSTER-01 -Mode scom -Environment Prod   # Disable maintenance mode
Set-MaintenanceMode -Action validate -TargetId CLU-CLUSTER-01 -Mode scom -Environment Prod  # Check status
```
...
### In this document
- [HPE ProLiant Windows Server ISO Automation (Root Readme)](#markdown-header-hpe-proliant-windows-server-iso-automation-root-readme)
  - [🚀 Quick Start - Setup & Installation](#markdown-header-quick-start-setup-installation)
    - [TL;DR - One-Line Setup](#markdown-header-tldr-one-line-setup)
  - [Table of Contents](#markdown-header-table-of-contents)
    - [Internal docs index](#markdown-header-internal-docs-index)
      - [Core Documentation](#markdown-header-core-documentation)
      - [Maintenance Mode & Scheduling](#markdown-header-maintenance-mode-scheduling)
      - [Integration & Authentication](#markdown-header-integration-authentication)
      - [Developer Resources](#markdown-header-developer-resources)
  - [Project Architecture](#markdown-header-project-architecture)
  - [Generated Audit Logs (JSON)](#markdown-header-generated-audit-logs-json)
  - [Quick Links for Common Tasks](#markdown-header-quick-links-for-common-tasks)
  - [GitLab Pipeline Files](#markdown-header-gitlab-pipeline-files)
    - [Pipeline Activation](#markdown-header-pipeline-activation)
  - [Contributing](#markdown-header-contributing)
  - [Support](#markdown-header-support)
  - [License](#markdown-header-license)
  - [HPe Doc](#markdown-header-hpe-doc)
