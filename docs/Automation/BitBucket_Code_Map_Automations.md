...
- [Automation Code Map](#automation-code-map)
  ...
  - [10. PowerShell Execution Utilities](#10-powershell-execution-utilities)
    ...
    - [10.2 — Remote PowerShell via WinRM](#102--remote-powershell-via-winrm)
  - [11. OpsRamp Integration](#11-opsramp-integration)
    - [11.1 — OpsRamp\_Client Class](#111--opsramp_client-class)
    - [11.2 — OpsRamp Entry Points](#112--opsramp-entry-points)
  - [12. Credential Resolution](#12-credential-resolution)
  - [13. Inventory \& Configuration](#13-inventory--configuration)
    - [13.1 — Inventory Functions](#131--inventory-functions)
...
- [Automation Code Map](#markdown-header-automation-code-map)
  ...
  - [9. Pre \& Post Build Validation](#markdown-header-9-pre-post-build-validation)
  ...
  - [11. OpsRamp Integration](#markdown-header-11-opsramp-integration)
    - [11.1 — OpsRamp\_Client Class](#markdown-header-111-opsramp_client-class)
...
>>>>>>> ecfd2a0 (Update table of contents for consistency and clarity)
...
=======
| Shared value type | [L19–33](../src/powershell/Automation/Automation.psm1#lines-19-L33) | `CommandResult` class — holds `ReturnCode`, `StandardOutput`, `StandardError`, `Success` |
| Shared reference type | [L38–106](../src/powershell/Automation/Automation.psm1#lines-38:106) | `AuditLogger` class — timestamped JSON audit log with `Log()`, `Save()`, `AppendToMaster()` |
| OpsRamp REST client | [L136–335](../src/powershell/Automation/Automation.psm1#lines-136:335) | `OpsRamp_Client` class — OAuth2 token management, REST calls, metric/alert/event senders |
| iLO Redfish session | [L340–471](../src/powershell/Automation/Automation.psm1#lines-340:471) | `IloRedfishSession` class — Redfish session login/logout, virtual media, boot override, system reset |
| Base class | [L476–528](../src/powershell/Automation/Automation.psm1#lines-476:528) | `AutomationBase` class — config dir, output dir, dry-run flag, audit, `RunCommand()` |
| Private script load | [L530–557](../src/powershell/Automation/Automation.psm1#lines-530:557) | Dot-sources `Private/*.ps1` in dependency order (see §1.2) |
| Public script load | [L559–565](../src/powershell/Automation/Automation.psm1#lines-559:565) | Dot-sources `Public/*.ps1` alphabetically |
| Export surface | [L569–648](../src/powershell/Automation/Automation.psm1#lines-569:648) | `Export-ModuleMember` — explicit public API |
>>>>>>> 9c58cfc (fix markdown)
...
=======
Dot-sourced in dependency order by [`Automation.psm1`](../src/powershell/Automation/Automation.psm1#lines-538:549):
>>>>>>> 9c58cfc (fix markdown)
...
=======
Loaded alphabetically by [`Automation.psm1`](../src/powershell/Automation/Automation.psm1#lines-559:565). Order:
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Router.ps1`](../src/powershell/Automation/Private/Router.ps1#lines-20)** — [`Invoke-RoutedRequest()`](../src/powershell/Automation/Private/Router.ps1#lines-20)
- Loads routing table from `request_types.json` at [L9–13](../src/powershell/Automation/Private/Router.ps1#lines-9:13)
- Dispatches by calling handler with `@Params` splat at [L54](../src/powershell/Automation/Private/Router.ps1#lines-54)
- Returns `Success=false` for unknown types at [L43–49](../src/powershell/Automation/Private/Router.ps1#lines-43:49)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Start-AutomationOrchestrator.ps1`](../src/powershell/Automation/Public/Start-AutomationOrchestrator.ps1#lines-5)** — [`Start-AutomationOrchestrator()`](../src/powershell/Automation/Public/Start-AutomationOrchestrator.ps1#lines-5)
- Validates request via [`_Validate-Request()`](../src/powershell/Automation/Public/_Validate-Request.ps1#lines-5) at [L37](../src/powershell/Automation/Public/Start-AutomationOrchestrator.ps1#lines-37)
- Routes via [`Invoke-RoutedRequest()`](../src/powershell/Automation/Private/Router.ps1#lines-20) at [L46](../src/powershell/Automation/Public/Start-AutomationOrchestrator.ps1#lines-46)
- Adds `Timestamp` and `RequestType` to result at [L47–48](../src/powershell/Automation/Public/Start-AutomationOrchestrator.ps1#lines-47:48)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`_Validate-Request.ps1`](../src/powershell/Automation/Public/_Validate-Request.ps1#lines-5)** — [`_Validate-Request()`](../src/powershell/Automation/Public/_Validate-Request.ps1#lines-5)

| Check | Lines | Logic |
|-------|-------|-------|
| Build params | [L31–33](../src/powershell/Automation/Public/_Validate-Request.ps1#lines-31:33) | Calls `Test-BuildParams` for `build_iso` / `patch_windows` |
| Maintenance target | [L34–39](../src/powershell/Automation/Public/_Validate-Request.ps1#lines-34:39) | Calls `Test-ClusterId` for `maintenance_*` requests |
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Control.ps1`](../src/powershell/Automation/Public/Control.ps1#lines-193)** — [`Run-CIPipeline()`](../src/powershell/Automation/Public/Control.ps1#lines-193)
- Builds CI params via [`_Build-CIParams()`](../src/powershell/Automation/Public/Control.ps1#lines-27) mapping:
>>>>>>> 9c58cfc (fix markdown)
...
=======
- Executes via [`_Execute()`](../src/powershell/Automation/Public/Control.ps1#lines-164)
>>>>>>> 9c58cfc (fix markdown)
...
- Executes via [`_Execute()`](../src/powershell/Automation/Public/Control.ps1#164)
=======
**[`Control.ps1`](../src/powershell/Automation/Public/Control.ps1#lines-207)** — [`Run-IRequest()`](../src/powershell/Automation/Public/Control.ps1#lines-207)
- Builds params via [`_Build-IRequestParams()`](../src/powershell/Automation/Public/Control.ps1#lines-64) mapping `cluster_id` + `action` → `maintenance_{action}`
- Executes via [`_Execute()`](../src/powershell/Automation/Public/Control.ps1#lines-164)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Control.ps1`](../src/powershell/Automation/Public/Control.ps1#lines-232)** — [`Run-Scheduler()`](../src/powershell/Automation/Public/Control.ps1#lines-232)
- Builds params via [`_Build-SchedulerParams()`](../src/powershell/Automation/Public/Control.ps1#lines-92) mapping:
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Control.ps1`](../src/powershell/Automation/Public/Control.ps1#lines-289)** — [`Run-GitLab()`](../src/powershell/Automation/Public/Control.ps1#lines-289)
- Builds params via [`_Build-GitLabParams()`](../src/powershell/Automation/Public/Control.ps1#lines-256)
- Routes to `gitlab_maintenance` request type
- Factory: [`New-GitLabCtrl()`](../src/powershell/Automation/Public/Control.ps1#lines-275)

**[`Invoke-GitLabMaintenanceTrigger.ps1`](../src/powershell/Automation/Public/Invoke-GitLabMaintenanceTrigger.ps1#lines-7)** — [`Invoke-GitLabMaintenanceTrigger()`](../src/powershell/Automation/Public/Invoke-GitLabMaintenanceTrigger.ps1#lines-7)
- Dot-sources [`Send-GitLabMaintenanceRequest.ps1`](../scripts/gitlab/Send-GitLabMaintenanceRequest.ps1) at [L84–94](../src/powershell/Automation/Public/Invoke-GitLabMaintenanceTrigger.ps1#lines-84:94)
- Calls [`Send-GitLabMaintenanceRequest()`](../scripts/gitlab/Send-GitLabMaintenanceRequest.ps1) at [L97–100](../src/powershell/Automation/Public/Invoke-GitLabMaintenanceTrigger.ps1#lines-97:100)
- Returns pipeline ID and URL on success at [L102–110](../src/powershell/Automation/Public/Invoke-GitLabMaintenanceTrigger.ps1#lines-102:110)
>>>>>>> 9c58cfc (fix markdown)
...
=======
- Validates HTTPS-only at [L28–31](../scripts/gitlab/Send-WebCallback.ps1#lines-28:31)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Start-PhysicalServerBuild.ps1`](../src/powershell/Automation/Public/Start-PhysicalServerBuild.ps1#lines-18)** — [`Start-PhysicalServerBuild()`](../src/powershell/Automation/Public/Start-PhysicalServerBuild.ps1#lines-18)

One-call orchestrator for new HPE ProLiant server deployments. Steps:
1. **Pre-build validation** — `Test-PreBuildValidation` at [L189](../src/powershell/Automation/Public/Start-PhysicalServerBuild.ps1#lines-189)
2. **Build ConfigMgr bootable ISO** — `New-IsoBuild` at [L173](../src/powershell/Automation/Public/Start-PhysicalServerBuild.ps1#lines-173)
3. **Publish ISO to HTTPS** — `Publish-BootIso` at [L183](../src/powershell/Automation/Public/Start-PhysicalServerBuild.ps1#lines-183)
4. **Resolve iLO via OneView** — `Get-OneViewServerTarget` at [L203](../src/powershell/Automation/Public/Start-PhysicalServerBuild.ps1#lines-203)
5. **Mount ISO + force boot via iLO Redfish** — `Invoke-IloRedfish` at [L231](../src/powershell/Automation/Public/Start-PhysicalServerBuild.ps1#lines-231)
6. **Monitor installation** — `Start-InstallMonitor` at [L239](../src/powershell/Automation/Public/Start-PhysicalServerBuild.ps1#lines-239)
7. **Post-build validation** — `Test-PostBuildValidation` at [L247](../src/powershell/Automation/Public/Start-PhysicalServerBuild.ps1#lines-247)
8. **Audit log entry** at [L266](../src/powershell/Automation/Public/Start-PhysicalServerBuild.ps1#lines-266)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`New-IsoBuild.ps1`](../src/powershell/Automation/Public/New-IsoBuild.ps1#lines-13)** — [`New-IsoBuild()`](../src/powershell/Automation/Public/New-IsoBuild.ps1#lines-13)

Builds ConfigMgr bootable WinPE media (replaces old DSC/DISM firmware+patching pipeline). Uses `New-CMBootableMedia` from the ConfigurationManager module.

- Auto-detects ConfigMgr context: local module or PSRemoting to site server at [L249](../src/powershell/Automation/Public/New-IsoBuild.ps1#lines-249)
- Output naming: `WinSrv2025_HPE_BootableMedia_v<Major.Minor>.iso`
- Auto-increments version from existing ISOs at [L114](../src/powershell/Automation/Public/New-IsoBuild.ps1#lines-114)
- DryRun mode at [L155](../src/powershell/Automation/Public/New-IsoBuild.ps1#lines-155)
- Mock mode for tests at [L144](../src/powershell/Automation/Public/New-IsoBuild.ps1#lines-144)
- Writes `deployment_metadata.json` at [L239](../src/powershell/Automation/Public/New-IsoBuild.ps1#lines-239)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Publish-BootIso.ps1`](../src/powershell/Automation/Public/Publish-BootIso.ps1#lines-12)** — [`Publish-BootIso()`](../src/powershell/Automation/Public/Publish-BootIso.ps1#lines-12)
- Copies bootable ISO to HTTPS repository for iLO Redfish consumption
- Verifies reachability with HTTP HEAD at [L114](../src/powershell/Automation/Public/Publish-BootIso.ps1#lines-114)
- `RepoBaseUrl` from `$env:ISO_REPO_BASE_URL` at [L61](../src/powershell/Automation/Public/Publish-BootIso.ps1#lines-61)
- `-ForceOverwrite` to replace existing ISOs at [L97](../src/powershell/Automation/Public/Publish-BootIso.ps1#lines-97)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Update-Firmware.ps1`](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-19)** — [`Update-Firmware()`](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-19)
- Default config: `configs/hpe_firmware_drivers_nov2025.json`
- Default output: `output/firmware`
- Delegates to [`FirmwareUpdater`](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-82) class at [L67](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-67)
- Saves per-server result JSON at [L73](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-73)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Update-Firmware.ps1`](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-82)** — class starts at [L82](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-82)
>>>>>>> 9c58cfc (fix markdown)
...
=======
| `FirmwareUpdater()` | [L94](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-94) | Constructor: loads config, finds SUT binary, reads download credentials |
| `_FindSut()` | [L110](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-110) | Locates `hpe_sut` in `tools/`, Program Files, or PATH |
| `_DetectGen()` | [L126](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-126) | Detects Gen10 vs Gen10+ from server name |
| `_ComponentsForGen()` | [L132](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-132) | Resolves firmware/driver components for server generation |
| `_Log()` | [L147](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-147) | Adds timestamped build log entry |
| `_RunSut()` | [L154](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-154) | Invokes `hpe_sut create` via [`Invoke-NativeCommandWithRetry()`](../src/powershell/Automation/Private/Executor.ps1#lines-68) |
| `Build()` | [L171](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-171) | Full firmware ISO build: detect gen → resolve components → invoke SUT |

**SUT command** at [L201–202](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-201:202):
>>>>>>> 9c58cfc (fix markdown)
```
...
=======
**[`Update-WindowsSecurity.ps1`](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-8)** — [`Invoke-WindowsSecurityUpdate()`](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-8)
- Default patches config: `configs/windows_patches.json`
- Default output: `output/patched`
- Creates [`WindowsPatcher`](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-88) instance at [L74](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-74) (3 params: config, baseIsoDir, outputDir)
- Calls `Build()` at [L75](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-75)
- Saves patch result JSON at [L78](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-78)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Update-WindowsSecurity.ps1`](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-88)** — class starts at [L88](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-88)
>>>>>>> 9c58cfc (fix markdown)
...
=======
| `WindowsPatcher()` | [L96](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-96) | Constructor: loads patch config, creates patch directory |
| `_LoadConfig()` | [L106](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-106) | Returns parsed patches config |
| `_Log()` | [L108](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-108) | Adds timestamped build log entry |
| `_SetupBaseIso()` | [L113](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-113) | Mounts Windows ISO via `Mount-DiskImage` (Windows) or extracts directory |
| `_ApplyPatchesDism()` | [L138](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-138) | Applies MSU patches via `dism /Add-Package` |
| `_ApplyPatchesPowerShell()` | [L156](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-156) | Applies patches via `Add-WindowsPackage` cmdlet |
| `Build()` | [L175](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-175) | Full patch pipeline: mount ISO → apply patches → export patched ISO |
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Invoke-IsoDeploy.ps1`](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-20)** — [`Invoke-IsoDeploy()`](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-20)
- Default ISO directory: `output/bootable_media`
- Only supports `Method`: `redfish`
- Creates [`ISODeployer`](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-89) at [L72](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-72)
- Single-server mode via `Deploy()` at [L182](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-182)
- Bulk mode via `DeployAll()` at [L199](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-199)
- Delegates actual mount+boot to `Invoke-IloRedfish` at [L175](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-175)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Invoke-IsoDeploy.ps1`](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-89)** — class starts at [L89](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-89)
>>>>>>> 9c58cfc (fix markdown)
...
=======
| `ISODeployer()` | [L97](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-97) | Constructor: loads server list via `Load-ServerList()` |
| `_FindServerPackage()` | [L106](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-106) | Resolves server name to `output/bootable_media/` subdirectory |
| `_ResolveIsoUrl()` | [L125](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-125) | Resolves ISO URL from metadata + RepoBaseUrl |
| `_Log()` | [L151](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-151) | Adds timestamped deploy log entry |
| `_DeployViaRedfish()` | [L159](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-159) | Delegates to `Invoke-IloRedfish -Action MountAndBoot` |
| `Deploy()` | [L182](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-182) | Dispatches to Redfish method |
| `DeployAll()` | [L199](../src/powershell/Automation/Public/Invoke-IsoDeploy.ps1#lines-199) | Iterates all servers, saves deployment summary JSON |
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Invoke-IloRedfish.ps1`](../src/powershell/Automation/Public/Invoke-IloRedfish.ps1#lines-19)** — [`Invoke-IloRedfish()`](../src/powershell/Automation/Public/Invoke-IloRedfish.ps1#lines-19)
- Actions: `Mount`, `MountAndBoot`, `Boot`, `Reset`, `Eject`, `Status`
- Uses `IloRedfishSession` class for Redfish API calls
- `-Force` required for destructive actions (`MountAndBoot`, `Boot`, `Reset`) at [L87–93](../src/powershell/Automation/Public/Invoke-IloRedfish.ps1#lines-87:93)
- Credentials from `Get-IloCredentials` at [L107](../src/powershell/Automation/Public/Invoke-IloRedfish.ps1#lines-107)
- Redfish session at [L113](../src/powershell/Automation/Public/Invoke-IloRedfish.ps1#lines-113)
- Session logout in `finally` block at [L155](../src/powershell/Automation/Public/Invoke-IloRedfish.ps1#lines-155)

**Redfish API endpoints** (documented at [L11–16](../src/powershell/Automation/Public/Invoke-IloRedfish.ps1#lines-11:16)):
- `POST /redfish/v1/SessionService/Sessions` — login → `X-Auth-Token`
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Automation.psm1`](../src/powershell/Automation/Automation.psm1#lines-340)** — class starts at [L340](../src/powershell/Automation/Automation.psm1#lines-340)
>>>>>>> 9c58cfc (fix markdown)
...
=======
| `IloRedfishSession()` | [L349](../src/powershell/Automation/Automation.psm1#lines-349) | Constructor: stores params, calls `_Login()` |
| `_Login()` | [L361](../src/powershell/Automation/Automation.psm1#lines-361) | POST session login → extracts token |
| `_Headers()` | [L372](../src/powershell/Automation/Automation.psm1#lines-372) | Returns `X-Auth-Token` header dict |
| `_Post()` | [L385](../src/powershell/Automation/Automation.psm1#lines-385) | POST JSON with auth |
| `_Patch()` | [L376](../src/powershell/Automation/Automation.psm1#lines-376) | PATCH JSON with auth |
| `_Get()` | [L394](../src/powershell/Automation/Automation.psm1#lines-394) | GET with auth |
| `GetSystem()` | [L401](../src/powershell/Automation/Automation.psm1#lines-401) | Returns power state, boot source, model, serial |
| `ListVirtualMedia()` | [L413](../src/powershell/Automation/Automation.psm1#lines-413) | Enumerates virtual media devices |
| `InsertMedia()` | [L433](../src/powershell/Automation/Automation.psm1#lines-433) | Mounts ISO URL into virtual media device |
| `EjectMedia()` | [L439](../src/powershell/Automation/Automation.psm1#lines-439) | Ejects virtual media |
| `SetOneTimeBootCd()` | [L445](../src/powershell/Automation/Automation.psm1#lines-445) | One-time boot override to CD |
| `ResetSystem()` | [L455](../src/powershell/Automation/Automation.psm1#lines-455) | System reset (ForceRestart) |
| `Logout()` | [L460](../src/powershell/Automation/Automation.psm1#lines-460) | DELETE session |
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Start-InstallMonitor.ps1`](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-8)** — [`Start-InstallMonitor()`](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-8)
- Polls iLO Redfish + WinRM to track Windows installation phases
- Sends progress metrics and alerts to OpsRamp
- Default timeout: 7200s (2 hours), poll interval: 30s
- Creates [`InstallationMonitor`](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-94) at [L49](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-49)
- Single server at [L53](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-53), bulk at [L57](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-57)

**Phase mapping** at [L88–91](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-88:91):
>>>>>>> 9c58cfc (fix markdown)
```
...
=======
**[`Start-InstallMonitor.ps1`](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-94)** — class starts at [L94](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-94)
>>>>>>> 9c58cfc (fix markdown)
...
=======
| `InstallationMonitor()` | [L106](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-106) | Constructor: loads server list, initializes OpsRamp client |
| `_InitOpsRampClient()` | [L115](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-115) | Creates `OpsRamp_Client` from config path |
| `_Log()` | [L121](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-121) | Adds timestamped monitoring log entry |
| `CheckIloStatus()` | [L126](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-126) | Ping + Redfish query → power state, boot source |
| `CheckWinRM()` | [L147](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-147) | Tests WSMan accessibility via `Test-WSMan` |
| `QueryInstallProgressWinRM()` | [L156](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-156) | Reads `HKLM:\SYSTEM\Setup` registry + Setup event log via WinRM |
| `_SendOpsRampMetric()` | [L191](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-191) | Sends progress metrics to OpsRamp |
| `_SendOpsRampAlert()` | [L198](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-198) | Sends alerts on timeout/failure/completion |
| `MonitorServer()` | [L204](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-204) | Polling loop: iLO + WinRM → progress tracking |
| `MonitorAll()` | [L285](../src/powershell/Automation/Public/Start-InstallMonitor.ps1#lines-285) | Monitors all servers, writes summary JSON |
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Test-PreBuildValidation.ps1`](../src/powershell/Automation/Public/Test-PreBuildValidation.ps1#lines-15)** — [`Test-PreBuildValidation()`](../src/powershell/Automation/Public/Test-PreBuildValidation.ps1#lines-15)

Pre-build checks from the runbook:
1. OneView target identified (via `Get-OneViewServerTarget`) at [L106](../src/powershell/Automation/Public/Test-PreBuildValidation.ps1#lines-106)
2. ISO URL reachable (HTTP HEAD) at [L120](../src/powershell/Automation/Public/Test-PreBuildValidation.ps1#lines-120)
3. iLO credentials verified (Redfish session test) at [L131](../src/powershell/Automation/Public/Test-PreBuildValidation.ps1#lines-131)
4. Management Point / Distribution Point reachability at [L150](../src/powershell/Automation/Public/Test-PreBuildValidation.ps1#lines-150)
5. Audit entry recorded at [L162](../src/powershell/Automation/Public/Test-PreBuildValidation.ps1#lines-162)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Test-PostBuildValidation.ps1`](../src/powershell/Automation/Public/Test-PostBuildValidation.ps1#lines-16)** — [`Test-PostBuildValidation()`](../src/powershell/Automation/Public/Test-PostBuildValidation.ps1#lines-16)

Post-build checks via WinRM:
1. WinRM reachable at [L89](../src/powershell/Automation/Public/Test-PostBuildValidation.ps1#lines-89)
2. Expected hostname assigned at [L124](../src/powershell/Automation/Public/Test-PostBuildValidation.ps1#lines-124)
3. OS version + edition verified at [L125–126](../src/powershell/Automation/Public/Test-PostBuildValidation.ps1#lines-125:126)
4. Domain join successful at [L127](../src/powershell/Automation/Public/Test-PostBuildValidation.ps1#lines-127)
5. HPE device drivers present at [L129](../src/powershell/Automation/Public/Test-PostBuildValidation.ps1#lines-129)
6. ConfigMgr client healthy at [L132–133](../src/powershell/Automation/Public/Test-PostBuildValidation.ps1#lines-132:133)
7. RDP operational at [L135](../src/powershell/Automation/Public/Test-PostBuildValidation.ps1#lines-135)
8. Audit entry recorded at [L156](../src/powershell/Automation/Public/Test-PostBuildValidation.ps1#lines-156)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Test-ServerConnectivity.ps1`](../src/powershell/Automation/Public/Test-ServerConnectivity.ps1#lines-157)** — [`Test-ServerConnectivity()`](../src/powershell/Automation/Public/Test-ServerConnectivity.ps1#lines-157)

Read-only connectivity test safe during change freezes (694 lines):
- **Phase 1: Network Ping** — DNS resolution + TCP port probe at [L448–497](../src/powershell/Automation/Public/Test-ServerConnectivity.ps1#lines-448:497)
- **Phase 2: Auth Connect** — Full authentication via module (SCOM or OneView) + immediate disconnect at [L502–583](../src/powershell/Automation/Public/Test-ServerConnectivity.ps1#lines-502:583)
- Host resolution: `-ManagementHost` → `$env:MAINTENANCE_HOST` → `connection_hosts.json` → interactive prompt
- `-DryRun` returns mock data at [L393](../src/powershell/Automation/Public/Test-ServerConnectivity.ps1#lines-393)
- `-Json` for API integration at [L598](../src/powershell/Automation/Public/Test-ServerConnectivity.ps1#lines-598)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Invoke-PowerShellScript.ps1`](../src/powershell/Automation/Public/Invoke-PowerShellScript.ps1#lines-5)** — [`Invoke-PowerShellScript()`](../src/powershell/Automation/Public/Invoke-PowerShellScript.ps1#lines-5)
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Invoke-PowerShellWinRM.ps1`](../src/powershell/Automation/Public/Invoke-PowerShellWinRM.ps1#lines-5)** — [`Invoke-PowerShellWinRM()`](../src/powershell/Automation/Public/Invoke-PowerShellWinRM.ps1#lines-5)
>>>>>>> 9c58cfc (fix markdown)
...
=======
Defined in [`Automation.psm1`](../src/powershell/Automation/Automation.psm1#lines-136), fully documented in [§11.2 of this document](#markdown-header-112-opsramp-entry-points).

| Member | Line | Purpose |
|--------|------|---------|
| `OpsRamp_Client()` | [L150](../src/powershell/Automation/Automation.psm1#lines-150) | Constructor: loads config, creates HttpClient |
| `_LoadConfig()` | [L161](../src/powershell/Automation/Automation.psm1#lines-161) | Loads config, overrides credentials from env vars |
| `EnsureToken()` | [L177](../src/powershell/Automation/Automation.psm1#lines-177) | OAuth2 client_credentials flow, token caching with 90% TTL |
| `_MakeRequest()` | [L209](../src/powershell/Automation/Automation.psm1#lines-209) | Generic HTTP request with auth |
| `SendMetric()` | [L240](../src/powershell/Automation/Automation.psm1#lines-240) | POST metric gauge |
| `SendAlert()` | [L257](../src/powershell/Automation/Automation.psm1#lines-257) | POST alert |
| `SendEvent()` | [L271](../src/powershell/Automation/Automation.psm1#lines-271) | POST event |
| `BatchSendMetrics()` | [L284](../src/powershell/Automation/Automation.psm1#lines-284) | Batch POST metrics |
| `ReportBuildStatus()` | [L289](../src/powershell/Automation/Automation.psm1#lines-289) | Build status metric + failure alert |
| `ReportDeploymentStatus()` | [L301](../src/powershell/Automation/Automation.psm1#lines-301) | Deploy status metric + failure alert |
| `ReportInstallationProgress()` | [L313](../src/powershell/Automation/Automation.psm1#lines-313) | Progress percent + elapsed seconds |
| `ReportVulnerabilityScan()` | [L322](../src/powershell/Automation/Automation.psm1#lines-322) | Vuln counts + critical alert |
>>>>>>> 9c58cfc (fix markdown)
...
=======
| [`Invoke-OpsRampClient()`](../src/powershell/Automation/Public/Invoke-OpsRampClient.ps1#lines-5) | L5 | Factory: creates `OpsRamp_Client` instance from config path |
| [`Invoke-OpsRamp()`](../src/powershell/Automation/Public/Invoke-OpsRampClient.ps1#lines-29) | L29 | Quick connectivity test — returns boolean from `EnsureToken()` |
>>>>>>> 9c58cfc (fix markdown)
...
=======
**Resolution order** (documented at [L5–14](../src/powershell/Automation/Private/Credentials.ps1#lines-5:14)):
>>>>>>> 9c58cfc (fix markdown)
...
=======
| [`_Resolve-Credential()`](../src/powershell/Automation/Private/Credentials.ps1#lines-17) | L17 | Core resolver — env → CLI → REST → default |
| [`Get-EnvCredential()`](../src/powershell/Automation/Private/Credentials.ps1#lines-127) | L127 | Generic env-var credential |
| [`Get-IloCredentials()`](../src/powershell/Automation/Private/Credentials.ps1#lines-145) | L145 | `ILO_USER` / `ILO_PASSWORD` |
| [`Get-ScomCredentials()`](../src/powershell/Automation/Private/Credentials.ps1#lines-158) | L158 | `SCOM_ADMIN_USER` / `SCOM_ADMIN_PASSWORD` |
| [`Get-OpenViewCredentials()`](../src/powershell/Automation/Private/Credentials.ps1#lines-173) | L173 | OpenView legacy credentials |
| [`Get-OneViewCredentials()`](../src/powershell/Automation/Private/Credentials.ps1#lines-183) | L183 | `ONEVIEW_USER` / `ONEVIEW_PASSWORD` |
| [`Get-SmtpCredentials()`](../src/powershell/Automation/Private/Credentials.ps1#lines-193) | L193 | SMTP email credentials |
>>>>>>> 9c58cfc (fix markdown)
...
=======
| [`Load-ServerList()`](../src/powershell/Automation/Private/Inventory.ps1#lines-5) | L5 | Reads `server_list.txt` → `ServerInfo[]` or plain strings |
| [`Load-ClusterCatalogue()`](../src/powershell/Automation/Private/Inventory.ps1#lines-46) | L46 | Loads `clusters_catalogue.json` → inner `clusters` hashtable |
| [`Test-ClusterDefinition()`](../src/powershell/Automation/Private/Inventory.ps1#lines-62) | L62 | Validates cluster definition fields: `display_name`, `servers`, `scom_group`, `environment` |
| [`New-ServerInfo()`](../src/powershell/Automation/Private/Inventory.ps1#lines-83) | L83 | Factory for `ServerInfo` objects |
>>>>>>> 9c58cfc (fix markdown)
...
=======
| [`Import-JsonConfig()`](../src/powershell/Automation/Private/Config.ps1#lines-5) | L5 | Reads JSON file, converts to hashtable, substitutes `${VAR}` env references |
| [`Import-YamlConfig()`](../src/powershell/Automation/Private/Config.ps1#lines-44) | L44 | Reads YAML file, converts to hashtable |
| [`_PS_ConvertTo-Hashtable()`](../src/powershell/Automation/Private/Config.ps1#lines-64) | L64 | Recursively converts PSCustomObject → hashtable |
| [`_PS_ReplaceEnvVars()`](../src/powershell/Automation/Private/Config.ps1#lines-88) | L88 | Replaces `${VAR}` placeholders with environment variable values |
| [`_PS_SubstituteEnvVars()`](../src/powershell/Automation/Private/Config.ps1#lines-108) | L108 | Recursive env-var substitution across all nested hashtables |
>>>>>>> 9c58cfc (fix markdown)
...
=======
| [`Test-BuildParams()`](../src/powershell/Automation/Public/Test-BuildParams.ps1#lines-5) | Validates base ISO path exists |
| [`Test-ClusterId()`](../src/powershell/Automation/Public/Test-ClusterId.ps1#lines-5) | Validates cluster ID in catalogue, checks required fields |
| [`Test-ServerList()`](../src/powershell/Automation/Public/Test-ServerList.ps1#lines-5) | Validates server list file, strips comments and empty lines |
>>>>>>> 9c58cfc (fix markdown)
...
=======
| [`Invoke-NativeCommand()`](../src/powershell/Automation/Private/Executor.ps1#lines-5) | L5 | Executes external program via `System.Diagnostics.Process`, captures stdout/stderr |
| [`Invoke-NativeCommandWithRetry()`](../src/powershell/Automation/Private/Executor.ps1#lines-68) | L68 | Exponential back-off retry wrapper (default: 3 attempts, 5s base delay) |
| [`New-CommandResult()`](../src/powershell/Automation/Private/Executor.ps1#lines-99) | L99 | Factory for `CommandResult` objects |

**Used by**: [`FirmwareUpdater._RunSut()`](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-154), [`WindowsPatcher._ApplyPatchesDism()`](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-138)
>>>>>>> 9c58cfc (fix markdown)
...
=======
| [`Ensure-DirectoryExists()`](../src/powershell/Automation/Private/FileIO.ps1#lines-5) | L5 | Creates directory tree if missing |
| [`Save-Json()`](../src/powershell/Automation/Private/FileIO.ps1#lines-18) | L18 | Serializes object to JSON file |
| [`Load-Json()`](../src/powershell/Automation/Private/FileIO.ps1#lines-35) | L35 | Deserializes JSON file |
| [`Save-JsonResult()`](../src/powershell/Automation/Private/FileIO.ps1#lines-53) | L53 | Saves to `{outputDir}/{category}/{basename}_{timestamp}.json` |
| [`Test-PathEx()`](../src/powershell/Automation/Private/FileIO.ps1#lines-77) | L77 | Enhanced Test-Path with better error messages |
| [`_FileIO_DeepHashtable()`](../src/powershell/Automation/Private/FileIO.ps1#lines-94) | L94 | Internal: deep conversion of PSCustomObject tree to hashtable |
>>>>>>> 9c58cfc (fix markdown)
...
=======
| [`Get-ProjectRoot()`](../src/powershell/Automation/Private/PathResolver.ps1#lines-5) | L5 | Walks up from cwd looking for `kilo.json` or `Makefile` |
| [`Get-LogDirectory()`](../src/powershell/Automation/Private/PathResolver.ps1#lines-32) | L32 | Returns `{projectRoot}/generated/logs/{category}` |
>>>>>>> 9c58cfc (fix markdown)
...
=======
| [`Initialize-Logging()`](../src/powershell/Automation/Private/Logging.ps1#lines-6) | L6 | Sets up log directory, creates timestamped log file |
| [`Get-Logger()`](../src/powershell/Automation/Private/Logging.ps1#lines-59) | L59 | Returns logger object with Info/Warning/Error/Debug methods |
>>>>>>> 9c58cfc (fix markdown)
...
=======
**[`Audit.ps1`](../src/powershell/Automation/Private/Audit.ps1#lines-5)** — [`New-AuditLogger()`](../src/powershell/Automation/Private/Audit.ps1#lines-5)
- Factory for `AuditLogger` class instances (20 lines)

Also defined as class in [`Automation.psm1`](../src/powershell/Automation/Automation.psm1#lines-38) (documented in [§1.1](#markdown-header-11-root-module-loader)):
- [`AuditLogger.Log()`](../src/powershell/Automation/Automation.psm1#lines-66) — adds entry with action, status, server, details
- [`AuditLogger.Save()`](../src/powershell/Automation/Automation.psm1#lines-82) — writes JSON file
- [`AuditLogger.AppendToMaster()`](../src/powershell/Automation/Automation.psm1#lines-99) — appends to master log
>>>>>>> 9c58cfc (fix markdown)
...
=======
| [`Get-UtcTimestamp()`](../src/powershell/Automation/Private/Base.ps1#lines-5) | L5 | ISO-8601 UTC timestamp |
| [`Get-LocalTimestamp()`](../src/powershell/Automation/Private/Base.ps1#lines-13) | L13 | ISO-8601 local timestamp |
| [`Get-UtcFileTimestamp()`](../src/powershell/Automation/Private/Base.ps1#lines-21) | L21 | `yyyy-MM-ddTHH-mm-ssZ` (filesystem-safe) |
| [`Get-UtcApiTimestamp()`](../src/powershell/Automation/Private/Base.ps1#lines-29) | L29 | SCOM REST API format |
| [`Convert-ToUtcIso8601()`](../src/powershell/Automation/Private/Base.ps1#lines-37) | L37 | Converts arbitrary datetime to UTC ISO-8601 |
| [`Get-LogTimestamp()`](../src/powershell/Automation/Private/Base.ps1#lines-51) | L51 | Log-friendly timestamp |
| [`Get-FileTimestamp()`](../src/powershell/Automation/Private/Base.ps1#lines-59) | L59 | File-safe timestamp |
| [`Get-DateFileTimestamp()`](../src/powershell/Automation/Private/Base.ps1#lines-67) | L67 | Date-only file timestamp |
| [`New-AutomationBase()`](../src/powershell/Automation/Private/Base.ps1#lines-75) | L75 | Factory for `AutomationBase` class |
>>>>>>> 9c58cfc (fix markdown)
...
=======
| **`request_types.json`** | Request type → handler mapping, CI stage map | [`Router.ps1`](../src/powershell/Automation/Private/Router.ps1#lines-9) |
| **`server_list.txt`** | Server hostnames with optional IPMI/iLO IPs | [`Inventory.ps1`](../src/powershell/Automation/Private/Inventory.ps1#lines-5) |
| **`clusters_catalogue.json`** | Cluster definitions with servers, SCOM groups, OneView scopes | [`Inventory.ps1`](../src/powershell/Automation/Private/Inventory.ps1#lines-46) |
| **`hpe_firmware_drivers_nov2025.json`** | HPE SUT firmware/driver component manifest | [`Update-Firmware.ps1`](../src/powershell/Automation/Public/Update-Firmware.ps1#lines-97) |
| **`windows_patches.json`** | Windows security patch KB list (MSU packages) | [`Update-WindowsSecurity.ps1`](../src/powershell/Automation/Public/Update-WindowsSecurity.ps1#lines-100) |
| **`opsramp_config.json`** | OpsRamp API credentials + base URL | [`OpsRamp_Client`](../src/powershell/Automation/Automation.psm1#lines-161) |
| **`connection_hosts.json`** | SCOM/OneView management hosts per environment | [`Test-ServerConnectivity.ps1`](../src/powershell/Automation/Public/Test-ServerConnectivity.ps1#lines-281) |
| **`scom_config.json`** | SCOM connection config (module, WinRM, credentials) | [`Test-ServerConnectivity.ps1`](../src/powershell/Automation/Public/Test-ServerConnectivity.ps1#lines-347) |
| **`oneview_config.json`** | OneView connection config (module, WinRM, credentials) | [`Test-ServerConnectivity.ps1`](../src/powershell/Automation/Public/Test-ServerConnectivity.ps1#lines-353) |
>>>>>>> 9c58cfc (fix markdown)
