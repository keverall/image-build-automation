...
- [11. OpsRamp Integration](#11-opsramp-integration)
  - [11.1 - OpsRamp_Client Class](#111-opsramp_client-class)
...
This document maps every code location in the automation module **excluding** maintenance mode (which is fully documented in [`GitHub_Code_Map_Maitenance_Mode.md`](../Maintenance-Mode/GitHub_Code_Map_Maitenance_Mode.md#top)). It is organized in the **chronological order a user or caller encounters each feature** - from module loading, through request routing, physical server builds, firmware/Windows patching, deployment, monitoring, validation, and OpsRamp reporting.
...
<a id="32-configmgr-bootable-iso-builder"></a>
...
<a id="4-firmware-iso-builder-standalone"></a>
...
<a id="7-ilo-redfish-integration"></a>

## 7. iLO Redfish Integration

<a id="71-invoke-iloredfish"></a>
...
<a id="72-iloredfishsession-class"></a>
...
<a id="8-installation-monitoring"></a>

## 8. Installation Monitoring

<a id="81-start-installmonitor"></a>
...
<a id="82-installationmonitor-class"></a>
...
<a id="9-pre-post-build-validation"></a>

## 9. Pre & Post Build Validation

<a id="91-test-prebuildvalidation"></a>
...
<a id="92-test-postbuildvalidation"></a>
...
<a id="93-test-serverconnectivity"></a>
...
<a id="10-powershell-execution-utilities"></a>

## 10. PowerShell Execution Utilities

<a id="101-local-powershell-execution"></a>
...
<a id="102-remote-powershell-via-winrm"></a>
...
<a id="11-opsramp-integration"></a>

## 11. OpsRamp Integration

<a id="111-opsramp_client-class"></a>
...
<a id="112-opsramp-entry-points"></a>
...
<a id="12-credential-resolution"></a>
...
<a id="13-inventory-configuration"></a>

## 13. Inventory & Configuration

<a id="131-inventory-functions"></a>
...
<a id="132-configuration-functions"></a>
...
<a id="133-validator-functions"></a>
...
<a id="14-process-execution-retry"></a>
...
<a id="15-file-io-path-resolution"></a>

## 15. File I/O & Path Resolution

<a id="151-file-io-functions"></a>
...
<a id="16-logging-audit"></a>

## 16. Logging & Audit

<a id="161-logging-functions"></a>
...
<a id="17-script-helpers"></a>

## 17. Script Helpers

<a id="171-powershell-profile-setup"></a>
...
<a id="172-cisecurity-lint-scripts"></a>
...
<a id="173-setup-bootstrap-scripts"></a>
...
<a id="174-documentation-coverage-scripts"></a>
...
| ~~maintenance-only configs~~ | *See [GitHub_Code_Map_Maitenance_Mode.md §11](../Maintenance-Mode/GitHub_Code_Map_Maitenance_Mode.md#top)* | - |
