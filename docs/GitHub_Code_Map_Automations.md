...
- [Automation Code Map](#markdown-header-automation-code-map)
  ...
  - [2. Request Routing & Control Surfaces](#markdown-header-2-request-routing-control-surfaces)
    ...
    - [2.7 — GitHub Actions CI/CD Surface](#markdown-header-27-github-actions-cicd-surface)
...
This document maps every code location in the automation module **excluding** maintenance mode (which is fully documented in [`GitHub_Code_Map_Maitenance_Mode.md`](GitHub_Code_Map_Maitenance_Mode.md)). It is organized in the **chronological order a user or caller encounters each feature** — from module loading, through request routing, ISO builds, firmware/Windows patching, deployment, monitoring, and OpsRamp reporting.
...
4. [`Invoke-GitHubMaintenanceTrigger.ps1`](../src/powershell/Automation/Public/Invoke-GitHubMaintenanceTrigger.ps1) — GitHub Actions CI/CD trigger
...
14. [`Set-MaintenanceMode.ps1`](../src/powershell/Automation/Public/Set-MaintenanceMode.ps1) — *see GitHub_Code_Map_Maitenance_Mode.md*
...
After module load, requests arrive from one of four surfaces: CI pipeline, iRequest/ISAPI, Scheduled tasks, or GitHub Actions CI/CD. All surfaces converge on the central router.
...
| `github_maintenance` | `Invoke-GitHubMaintenanceTrigger` | null |
...
### 2.7 — GitHub Actions CI/CD Surface

**[`Control.ps1`](../src/powershell/Automation/Public/Control.ps1#L289)** — [`Run-GitHubActions()`](../src/powershell/Automation/Public/Control.ps1#L289)
- Builds params via [`_Build-GitHubParams()`](../src/powershell/Automation/Public/Control.ps1#L256)
- Routes to `github_maintenance` request type

**[`Invoke-GitHubMaintenanceTrigger.ps1`](../src/powershell/Automation/Public/Invoke-GitHubMaintenanceTrigger.ps1#L7)** — [`Invoke-GitHubMaintenanceTrigger()`](../src/powershell/Automation/Public/Invoke-GitHubMaintenanceTrigger.ps1#L7)
- Dot-sources [`Send-GitHubMaintenanceRequest.ps1`](../scripts/github/Send-GitHubMaintenanceRequest.ps1) at [L84–94](../src/powershell/Automation/Public/Invoke-GitHubMaintenanceTrigger.ps1#L84-L94)
- Calls [`Send-GitHubMaintenanceRequest()`](../scripts/github/Send-GitHubMaintenanceRequest.ps1) at [L97–100](../src/powershell/Automation/Public/Invoke-GitHubMaintenanceTrigger.ps1#L97-L100)
- Returns workflow run ID and URL on success at [L102–110](../src/powershell/Automation/Public/Invoke-GitHubMaintenanceTrigger.ps1#L102-L110)

**[`scripts/github/Send-GitHubMaintenanceRequest.ps1`](../scripts/github/Send-GitHubMaintenanceRequest.ps1)**
- Dispatches GitHub Actions workflow via workflow dispatch API (`POST /repos/{owner}/{repo}/actions/workflows/{workflow_id}/dispatches`)
- Monitors workflow run completion with timeout
- Sends web callback with results on completion

**[`scripts/github/Invoke-GitHubMaintenance.ps1`](../scripts/github/Invoke-GitHubMaintenance.ps1)**
- GitHub Actions workflow entry point — executed by workflow runner
- Wraps `Set-MaintenanceMode` with GitHub Actions-specific logging and callback support

**[`scripts/github/Send-WebCallback.ps1`](../scripts/github/Send-WebCallback.ps1)** — [`Send-WebCallback()`](../scripts/github/Send-WebCallback.ps1)
- POST JSON to HTTPS callback URL with optional API key
- Validates HTTPS-only at [L28–31](../scripts/github/Send-WebCallback.ps1#L28-L31)
...
| [`cyberark-bootstrap.ps1`](../scripts/cyberark-bootstrap.ps1) | 139 lines | Fetches secrets from CyberArk CCP, exports as env vars for GitHub Actions CI |
...
| **GitHub Actions maintenance** | `Run-GitHubActions` | `Invoke-GitHubMaintenanceTrigger` | [`Control.ps1`](../src/powershell/Automation/Public/Control.ps1) | L289–308 |
...
*Maintenance mode excluded — see [`GitHub_Code_Map_Maitenance_Mode.md`](GitHub_Code_Map_Maitenance_Mode.md)*
