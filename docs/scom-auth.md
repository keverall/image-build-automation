...
```json
{
  "clusters": {
    "PROD-CLUSTER-01": {
      ...
      "scom_version": "2019",
      "scom_management_server": "VR-OPM19P1-7382.ad.aib.pri",
      "scom_environment": "production",
      "servers": [
        "prod-server-01.ad.aib.pri",
        "prod-server-02.ad.aib.pri",
        "prod-server-03.ad.aib.pri"
      ],
...
if (-not (Get-Module -ListAvailable -Name 'OperationsManager')) {
    ...
    Write-Warning "Import-Module \\VR-OPM19P1-7382.ad.aib.pri\share\OperationsManager"
}
