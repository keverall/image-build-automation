...
mm -Action enable -TargetId CLU-CLUSTER-01 -Mode scom -Environment Prod -ManagementHost backup-scom.ad.aib.pri -Start now -End +1hour
...
mm -Action enable -TargetId CLU-CLUSTER-01 -Mode scom -Environment Prod -ManagementHost emergency-scom.ad.aib.pri -Start now -End '+4hours' -NoSchedule
```
