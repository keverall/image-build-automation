...
New-SCOMManagementGroupConnection -ComputerName alpasopm12ms1.ad.aib.pri
$servers = Get-SCOMGroup -DisplayName "AIB Maintenance Mode Non 24-Hour Servers" | Get-SCOMClassInstance
...
#Defining Variables
$MgntSrv   = "alpasopm12ms2.ad.aib.pri"
