...
- [Change log:](#change-log)
  ...
  - [Change details](#change-details)
    ...
    - [27) Command prune + doc update: deploy flow, deleted commands, bug fixes](#27-command-prune--doc-update-deploy-flow-deleted-commands-bug-fixes)
      ...
      - [`Configure-PhysicalBuild` rewrite](#configure-physicalbuild-rewrite)
      - [`Start-PhysicalServerBuild` changes](#start-physicalserverbuild-changes)
      - [Documentation updates](#documentation-updates)
      - [Test script + unit test updates](#test-script--unit-test-updates)
      - [Bug fixes](#bug-fixes)
    ...
    - [22) Shared `_Publish-Result` / `-PassThru` output migration (15 Public commands)](#22-shared-_publish-result---passthru-output-migration-15-public-commands)
      - [Scope](#scope-1)
      - [Change](#change-5)
      - [Commands migrated](#commands-migrated)
      - [Caller + test updates](#caller--test-updates)
      - [Verification](#verification-23)
    - [21) Command documentation clarity — firmware/security/utility + repository corrections](#21-command-documentation-clarity--firmwaresecurityutility--repository-corrections)
      - [Change — command clarity](#change--command-clarity)
      - [Change — obsolete ISO-repository references](#change--obsolete-iso-repository-references)
    ...
    - [17) Get-OneViewConnectionStatus session-reuse guard (no reconnect)](#17-get-oneviewconnectionstatus-session-reuse-guard-no-reconnect)
      - [Root cause](#root-cause-18)
      - [Fix](#fix-18)
      - [Verification](#verification-28)
    - [16) Docs anchor fix — navigable `id` anchors for `make docs` / `make fix-docs`](#16-docs-anchor-fix--navigable-id-anchors-for-make-docs--make-fix-docs)
      - [Root cause](#root-cause-19)
      - [Fix](#fix-19)
      - [Verification](#verification-29)
    - [15) `Connect-OneView` \& `ConvertToWildcardRegex` docs + alias inventory tests](#15-connect-oneview--converttowildcardregex-docs--alias-inventory-tests)
      ...
      - [Alias inventory tests](#alias-inventory-tests)
    ...
    - [14) Parameter rename `SrvrId` → `ServerIdentifier` + wildcard filtering in `Get-OneViewServerList`](#14-parameter-rename-srvrid--serveridentifier--wildcard-filtering-in-get-oneviewserverlist)
      - [Parameter rename `SrvrId` → `ServerIdentifier`](#parameter-rename-srvrid--serveridentifier)
      - [Wildcard filtering in `Get-OneViewServerList`](#wildcard-filtering-in-get-oneviewserverlist)
    ...
    - [12) Shared output formatting + `Connect-OneView` rewrite + runbook v2](#12-shared-output-formatting--connect-oneview-rewrite--runbook-v2)
      - [Shared output formatting (`OutputFormatter.ps1`)](#shared-output-formatting-outputformatterps1)
      - [`Connect-OneView` rewrite](#connect-oneview-rewrite)
      - [Runbook requirements v2](#runbook-requirements-v2)
      - [Verification](#verification-33)
    ...
    - [10) Repo hygiene: LF normalization + git workflow docs](#10-repo-hygiene-lf-normalization--git-workflow-docs)
      ...
      - [Git workflow docs (`git_process.md`)](#git-workflow-docs-git_processmd)
    - [9) Parameter rename `ManagementHost` → `OneViewHost` + `Get-OneViewConnectionStatus` overhaul](#9-parameter-rename-managementhost--oneviewhost--get-oneviewconnectionstatus-overhaul)
      - [Parameter rename `ManagementHost` → `OneViewHost`](#parameter-rename-managementhost--oneviewhost)
      - [`Get-OneViewConnectionStatus` overhaul](#get-oneviewconnectionstatus-overhaul)
    ...
    - [8) Automated live testing harness + captured test results](#8-automated-live-testing-harness--captured-test-results)
      - [Harness](#harness)
      - [Captured results](#captured-results)
    - [7) OneView live-session guard + GuardRail (destructive-action gate)](#7-oneview-live-session-guard--guardrail-destructive-action-gate)
      - [Live Oneylive session guard](#live-oneylive-session-guard)
      - [Automated live scripts](#automated-live-scripts)
    ...
    - [6) Parameter-usage guard + non-interactive `-DryRun` (`--DryRun`/`-DryRun`)](#6-parameter-usage-guard--non-interactive--dryrun---dryrun-dryrun)
      - [Root cause](#root-cause-20)
      - [Fix](#fix-20)
      - [Verification](#verification-36)
    - [5) Profile auto-load fix + Setup-Profile regression test (catches "Connect-OneView not recognized")](#5-profile-auto-load-fix--setup-profile-regression-test-catches-connect-oneview-not-recognized)
      - [Root cause](#root-cause-21)
      - [Fix](#fix-21)
      - [Verification](#verification-37)
...
- [Query servers in maintenance mode                                                                                                             0  16:32:33    image-build-automation  main  $r\_mm = Invoke-RestMethod -Uri "https://va-oneviewt-01:443/rest/server-hardware?start=0\&count=-1\&query=`"maintenanceMode:'true'`"" \`            0  16:33:15 \>     -Headers @{ auth = $token } -Method Get -SkipCertificateCheck](#query-servers-in-maintenance-mode-------------------------------------------------------------------------------------------------------------0--163233----image-build-automation--main--r_mm--invoke-restmethod--uri-httpsva-oneviewt-01443restserver-hardwarestart0count-1querymaintenancemodetrue-------------0--163315-------headers--auth--token---method-get--skipcertificatecheck)
- [   image-build-automation  main  Get-OneViewServerList                                                                                                                           0  16:35:47 ](#---image-build-automation--main--get-oneviewserverlist---------------------------------------------------------------------------------------------------------------------------0--163547-)
- [Appliance: va-oneviewt-01](#appliance-va-oneviewt-01)
- [OneView Connectivity Test](#oneview-connectivity-test)
- [   image-build-automation  main  Get-OneViewServerList                                                                                                           0  34s 51ms  12:41:25 ](#---image-build-automation--main--get-oneviewserverlist-----------------------------------------------------------------------------------------------------------0--34s-51ms--124125-)
...
OMG-WISCLU-01ilo OMG-WISCLU-01 
n/a 
DL380 Gen9 

 
ALP-WISCLU-01ilo ALP-WISCLU-01  
n/a 
DL380 Gen9 
...
OMG-CONSTC1-02ilo 
not set 
OMG-CONSTC1-02 server profile DL380 Gen12 

 
ALP-CONSTC1-01ilo 
not set 
ALP-CONSTC1-01 server profile DL380 Gen12 

 
ALP-CONSTC2-01ilo 
not set 
ALP-CONSTC2-01 server profile DL380 Gen12 

 
OMG-CONSTC2-02ilo 
not set 
OMG-CONSTC2-02 server profile DL380 Gen12 

 
OMG-STARWAY-01ILO omg-starway-01 
n/a 
DL360 Gen10 

 
ALP-STARWAY-01ILO alp-starway-01 
n/a 
DL360 Gen10 

 
alp-qlikview-03ilo alp-qlikview-03 alp-qlikview-03 - Server profile DL360 Gen10 Plus 

 
omg-qlikview-03ilo omg-qlikview-03 omg-qlikview-03 - Server profile DL360 Gen10 Plus 
...
2026-09-22 11:41:02 - Connectivity - INFO - DNS resolution for 'va-oneviewt-01': Resolved -> 10.239.124.79 
2026-09-22 11:41:02 - Connectivity - INFO - TCP probe for 'va-oneviewt-01': Open (port 443, 20ms) 
...
2026-09-22 11:41:24 - Connectivity - INFO - Connectivity test for 'va-oneviewt-01' completed: Available=True (DNS=True, TCP=True, Auth=True) 
2026-09-22 11:41:24 - Connect-OneView - INFO - Connect-OneView result: Available=True Message='Connected to OneView appliance 'va-oneviewt-01'.' 
...
============================================== 
  ...
  Host:       va-oneviewt-01
  Environment:Prod
  Timestamp:  2026-09-22T11:41:24.3311556Z 

  --- Phase 1: Network Ping ---
    DNS:       Resolved
    IP:        10.239.124.79
    TCP:       Open (port 443, 20ms)       
...
   image-build-automation  main  Get-OneViewServerList                                                                                                           0  34s 51ms  12:41:25 
============================================== 
  OneView Server List (16 servers)
  Appliance: va-oneviewt-01
============================================== 
...
thankfully enable and disable maintenance mode still work, verified on hpeoneview ui web -


   image-build-automation  main  Get-OneViewServerTarget -ServerIdentifier CZ22420JCN                                                                                      0  12:41:39 
2026-09-22 11:44:45 - Get-OneViewServerTarget - INFO - Get-OneViewServerTarget resolved Id=CZ22420JCN (ResolvedBy=Serial)

==============================================
  OneView Server Target
==============================================
 
  Details:   name=omg-qlikview-03ilo, serial=CZ22420JCN, model=ProLiant DL360 Gen10 Plus, power=Off, health=OK, maint=No, ilo=10.30.54.22, enclosure=/0, rom=U46 v2.42 (06/13/2025)
 
  Resolved By:  Serial

==============================================

   image-build-automation  main  Get-OneViewServerTarget -ServerIdentifier CZ22420JCM                                                                                                                            0  12:44:46 2026-09-22 11:45:03 - Get-OneViewServerTarget - INFO - Get-OneViewServerTarget resolved Id=CZ22420JCM (ResolvedBy=Serial)

==============================================
  OneView Server Target
==============================================

  Details:   name=alp-qlikview-03ilo, serial=CZ22420JCM, model=ProLiant DL360 Gen10 Plus, power=Off, health=OK, maint=No, ilo=10.30.14.15, enclosure=/0, rom=U46 v2.42 (06/13/2025)

  Resolved By:  Serial

==============================================

   image-build-automation  main  Disable-OneViewMaintenanceMode -TargetId 'omg-qlikview-03ilo' -OneViewHost va-oneviewt-01                                                                                       0  12:45:03 WARNING: Disabling maintenance mode will cause email notifications to return to normal.
...
Objects                        {@{Type=server-hardware-12; Name=omg-qlikview-03ilo; Status=success; Message=Maintenance mode disabled}}
ResolvedBy                     Name
SerialNumber
Module                         HPEOneView.1000
SuccessCount                   1

   image-build-automation  main  Enable-OneViewMaintenanceMode -TargetId 'CZ22420JCN'                                                                                                                  0  5s 976ms  12:45:58 WARNING: Enabling maintenance mode will prevent this appliance from sending any email notifications related to server hardware omg-qlikview-03ilo and its associated profile. Maintenance mode will not affect normal server or profile operations.
...
----                           -----
TargetType                     ServerHardware
EndTime                        22/09/2026 15:48:19
StartTime                      22/09/2026 11:48:19
SerialNumber
SuccessCount                   1
Module                         HPEOneView.1000
TargetId                       CZ22420JCN
...
AlreadyCount                   0
ResolvedType                   ServerHardware
Objects                        {@{Type=server-hardware-12; Name=omg-qlikview-03ilo; Status=success; Message=Maintenance mode enabled}}
...
but Get-OneViewServerTarget -ServerIdentifier CZ22420JCM    is incorrct this server is definitely in maintenance mode and shows NO for not in maintenance mode returned for this command because as proved previously the list and get commands do no return the maintenance mode, yet the ui displays it correctly for each server it list or shows detail on, find how it does that and replicate it here and fix this                                                                                                                        0  12:44:46 2026-09-22 11:45:03 - Get-OneViewServerTarget - INFO - Get-OneViewServerTarget resolved Id=CZ22420JCM (ResolvedBy=Serial)
